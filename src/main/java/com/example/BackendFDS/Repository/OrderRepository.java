...
public interface OrderRepository extends JpaRepository<OrderEntity, Long>{
	...
	@Query(value="Select *FROM order1  WHERE id=:orderId and state=:state", nativeQuery = true)
	public void supplierStatusOrder(@Param("state") String state,@Param("orderId") long id);
}
